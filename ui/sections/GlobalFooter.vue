    ...
    <div class="max-w-4xl mx-auto mb-20">
      ...
      <div class="flex flex-col md:flex-row justify-between w-full gap-12 md:gap-0">
        ...
        <div class="flex flex-col gap-5 items-start">
          <h4 class="font-medium text-white tracking-widest uppercase text-xs text-left">Plataforma</h4>
        ...
        <!-- Categories Links -->
        <div class="flex flex-col gap-5 items-start">
          <h4 class="font-medium text-white tracking-widest uppercase text-xs text-left">Categorías</h4>
          <div class="flex flex-col gap-3 items-start text-left">
            <NuxtLink 
        ...
        <div class="flex flex-col gap-5 shrink-0 items-start">
          <h4 class="font-medium text-white tracking-widest uppercase text-xs text-left">Legal</h4>
          <div class="flex flex-col gap-3 items-start text-left">
          ...
          <h4 class="font-medium text-white tracking-widest uppercase text-xs text-left pt-2">Países</h4>
          <div class="flex flex-col gap-3 items-start text-left">
            <NuxtLink 
